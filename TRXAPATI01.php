            ...
            <div class="card-modern">
              ...
              <div class="form-grid">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="hidmastcode_asli" id="hidmastcode_asli" value="">
                </div>
                <div class="form-group">
                  ...
                  <input type="text" name="txtmainpidn" id="txtmainpidn" class="form-control" maxlength="16"
                    ...
                    onkeyup="if (value.length > 12) { var inEdit = document.getElementById('hidmastcode_asli').value.length > 0; if (!inEdit) { let inmastcode = value.substr(8,4); document.getElementById('txtmastcode').value = inmastcode; periksanomor('1'); } }"
