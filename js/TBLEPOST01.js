  ...
  if (aksesku.readyState==4)
    ...
    if(data.length>1)
      ...
      {
        document.getElementById('txtpostcode').setAttribute('disabled','true');
        document.getElementById('txtpostname').setAttribute('disabled','true');
      }
    }
  }
    ...
    if(data.length>1)
      {
        ...
        swal({
            title: 'Code is Exist' ,
            text: 'Kode Posisi sudah ada',
            icon: 'warning',
        });
      }
      else
      {
        document.getElementById("txtpostname").removeAttribute('disabled');
  ...
  if (ajaxview.readyState==4)
    {
      ...
      {
      var res = data.split("|");
      document.getElementById("txtpostcode").value = res[1];
      document.getElementById("txtpostname").removeAttribute('disabled');
      document.getElementById("txtpostname").value = res[2];
      }      
        //}
    }
  }
...
// Hapus 
  var ajaxhapus;
  function hapuscode(postcode)
  {
    ajaxhapus = buatajaxhapus();
    var url="TBLEPOST01D.php";
