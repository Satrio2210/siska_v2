...
// end periksa Kode
  ...
  var ajaxinput;
  function input(unitcode,unitname)
  {
    ajaxinput = buatajaxinput();
    var url="TBLLUNIT01E.php";
    ajaxinput.onreadystatechange=stateChangedInput;
    var params = "q="+unitcode+"|"+unitname;
    //alert(params);
