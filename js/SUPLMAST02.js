...
function isisuplmastcode(mastcode, mainname, mainaddr, maincity, mainctry, mainphne, mainfaxi, mainmail, mainwebs, mainpers, maintidn, mainterm, estiarrv, estideli, payalimt, bankname, bankcode, avaifrwd)
{
  ...
  document.getElementById('txtmainfaxi').removeAttribute('disabled');
  ...
  document.getElementById('txtmainwebs').removeAttribute('disabled');
  document.getElementById("txtmainwebs").value = mainwebs;

  document.getElementById('txtmainpers').removeAttribute('disabled');
  ...
  document.getElementById('txtmainterm').removeAttribute('disabled');
  document.getElementById("txtmainterm").value = mainterm;

  document.getElementById('txtestiarrv').removeAttribute('disabled');
  document.getElementById("txtestiarrv").value = estiarrv;

  document.getElementById('txtestideli').removeAttribute('disabled');
  document.getElementById("txtestideli").value = estideli;

  var nominallimit = convertToRupiah(Math.round(payalimt));
  document.getElementById('txtpayalimt').removeAttribute('disabled');
  ...
  document.getElementById('optavaifrwd').removeAttribute('disabled');
