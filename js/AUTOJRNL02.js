...
function isijrnlcode(salecode,paiddate)
{
	try 
	{
...
var drz;
function ambiltrxascreen(salecode)
{
  try {	
  drz = buatajaxtrxascreen();
  var url="AUTOJRNL02V.php";
  drz.onreadystatechange=stateChangedtrxascreen;
  var params = "q="+salecode;
...
var ajaxview
function viewcode(salecode)
{
  try 
  {
    ajaxview = buatajaxview();
    var url="AUTOJRNL02C-JRNL.php";
