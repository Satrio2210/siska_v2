  ...
  if (aksesku.readyState==4)
    ...
    if(data.length>1)
      ...
      {
        document.getElementById('txtbankcode').setAttribute('disabled','true');
        document.getElementById('txtbankname').setAttribute('disabled','true');
      }
    }
  }
...
// end periksa Kode
  ...
  var ajaxinput;
  function input(bankcode,bankname)
  {
    ajaxinput = buatajaxinput();
    //var url="INVETRANS06E.php";
    var url="TBLEBANK01E.php";
    ajaxinput.onreadystatechange=stateChangedInput;
    var params = "q="+bankcode+"|"+bankname;
    //alert(params);
...
var ajaxview
function viewcode(bankcode)
{
  try 
  {
    ajaxview = buatajaxview();
    //var url="INVETRANS06VIEW.php";
    var url="TBLEBANK01C.php";
  ...
  if (ajaxview.readyState==4)
    {
      ...
      {
      var res = data.split("|");
      document.getElementById("txtbankcode").value = res[1];
      document.getElementById("txtbankname").removeAttribute('disabled');
      document.getElementById("txtbankname").value = res[2];
      }      
        //}
    }
  }
...
// Hapus Transportasi di Tabel tblitrans
  var ajaxhapus;
  function hapuscode(bankcode)
  {
    ajaxhapus = buatajaxhapus();
    //var url="INVETRANS06D.php";
    var url="TBLEBANK01D.php";
