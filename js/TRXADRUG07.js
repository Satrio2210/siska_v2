...
function ambilviewprice(kata)
{
  if(kata.length > 13)
  {
  document.getElementById("tblviewprice").style.visibility = "hidden";
  }
  else
  {
  drz = buatajaxviewid();
  var url="TRXADRUG07V.php";
...
function stateChangedviewid()
{
  ...
  datapost=drz.responseText;
    ...
    {
    document.getElementById("tblviewprice").innerHTML = datapost;
    document.getElementById("tblviewprice").style.visibility = "";
    }
    else  
    {
    document.getElementById("tblviewprice").innerHTML = "";
    document.getElementById("tblviewprice").style.visibility = "hidden";
    }
  }
}
