...
<div class="table-wrapper">
  <table class="modern-table">
    <thead>
      <tr>
        <th class="w-50p" style="padding: 8px;">Obat</th>
        <th class="w-20p" style="padding: 8px;">Stock</th>
        <th class="w-30p" style="padding: 8px;">Harga/Tab/Btl</th>
    </thead>
    ...
    ' . $outstockquty . '
        ...
        echo '<td class="w-20p">' . $stokbadge . '</td>';

        echo '<td class="w-30p" style="text-align:right;">Rp ' . $view_outstockpric . '</td>';
